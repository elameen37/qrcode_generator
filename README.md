...
QR_Code_Generator
## Live link
 click [here]( https://qrcode-me.herokuapp.com/) to visit the website 
...
Allow user to download png and pdf format or share code by social media
...
I am a HR manager, I set up my account with the application. Then I paste my LinkedIn link and a QR code is generated for me. I have the option of downloading the code as PNG or sharing code by social media.
...
```bash
git clone https://github.com/elameen37/qr_generator.git
```
